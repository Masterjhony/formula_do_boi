            ...
            <div className="flex items-center gap-3">
                <label className="flex items-center gap-1.5 text-xs text-gray-500">
                    ...
                    <select
                        ...
                        className="px-2 py-1 text-xs rounded-lg border border-gray-200 dark:border-[#333] bg-white dark:bg-[#1A1A1A] text-gray-700 dark:text-gray-300 focus:outline-none focus:border-[#A0792E] cursor-pointer"
                    >
                ...
                {hasPages && (
                    <div className="flex items-center gap-1">
                        <button
                            ...
                            className="px-2 py-1 text-xs rounded-lg border border-gray-200 dark:border-[#333] disabled:opacity-40 hover:bg-gray-50 dark:hover:bg-[#222] transition-colors text-gray-600 dark:text-gray-300 inline-flex items-center"
                        >
