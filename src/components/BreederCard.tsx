...
export default function BreederCard({ breeder, rank }: BreederCardProps) {
    ...
    return (
        <Link
            ...
            className="group relative block w-full overflow-hidden rounded-xl bg-[#0f0f0f] border border-[#2a2a2a] hover:border-brand-gold/60 transition-all duration-500 hover:shadow-2xl hover:shadow-brand-gold/10"
        >
                ...
                {rank && (
                    <div className="absolute top-4 left-4 z-20">
                        <div className="relative">
                            ...
                            <div className="relative bg-[#0a0a0a]/90 backdrop-blur-md border border-brand-gold/50 px-3 py-1.5 rounded-lg flex flex-col items-center justify-center min-w-[60px]">
            ...
            <div className="relative z-20 px-6 pb-6 -mt-12">
                ...
                <div className="flex justify-center mb-4">
                    <div className="w-24 h-24 rounded-full border-4 border-[#0f0f0f] p-1 bg-[#1a1a1a] shadow-xl transform group-hover:translate-y-[-5px] transition-transform duration-500 relative">
                        <img
                ...
                <div className="text-center">
                    ...
                    {/* Stats Grid */}
                    <div className="grid grid-cols-2 gap-px bg-[#2a2a2a] border border-[#2a2a2a] rounded-lg overflow-hidden mb-6">
                        <div className="bg-[#141414] p-3 flex flex-col items-center group/stat hover:bg-[#1a1a1a] transition-colors">
                    ...
                    {/* Action Button */}
                    <div className="bg-brand-gold/10 hover:bg-brand-gold text-brand-gold hover:text-[#0a0a0a] border border-brand-gold/20 hover:border-brand-gold py-3 px-4 rounded-lg font-bold text-sm uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-2 group/btn">
                        Ver Portfólio
