...
export default function SemenDestaque({ products, isAuthenticated = true }: SemenDestaqueProps) {
    ...
    return (
        <section id="semen" className="stitch-divider py-20 bg-[#050505] border-t border-white/5 scroll-mt-20">
                ...
                <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {["Parceria Oficial Central Bela Vista", "11 Reprodutores Selecionados", "Ápice da Genética Provada Nacional"].map((s) => (
