        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button className="px-5 py-2.5 bg-[#111] border border-[#333] hover:border-[#B8860B]/50 text-white text-sm font-semibold rounded-xl transition-all shadow-lg hover:shadow-[#B8860B]/20 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0A0A0A] border border-[#2A2A2A] hover:border-[#B8860B]/40 rounded-2xl p-6 shadow-xl transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-4">
                        <p className="text-xs font-bold text-[#888] uppercase tracking-widest">Saldo Atual</p>
                ...
                <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0A0A0A] border border-[#2A2A2A] hover:border-[#B8860B]/40 rounded-2xl p-6 shadow-xl transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-4">
                        <p className="text-xs font-bold text-[#888] uppercase tracking-widest">A Pagar (Hoje)</p>
                ...
                <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0A0A0A] border border-[#2A2A2A] hover:border-[#B8860B]/40 rounded-2xl p-6 shadow-xl transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-4">
                        <p className="text-xs font-bold text-[#888] uppercase tracking-widest">Estoque Ativo</p>
                        <div className="p-2 bg-teal-500/10 rounded-lg group-hover:scale-110 transition-transform">
                            <Package className="w-5 h-5 text-teal-500" />
                        </div>
                    </div>
                    <p className="text-3xl font-extrabold text-white tracking-tight">0 <span className="text-lg text-[#666] font-medium">itens</span></p>
                ...
                <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0A0A0A] border border-[#2A2A2A] hover:border-[#B8860B]/40 rounded-2xl p-6 shadow-xl transition-all duration-300 group">
                    <div className="flex items-center justify-between mb-4">
                        <p className="text-xs font-bold text-[#888] uppercase tracking-widest">Colaboradores</p>
                    ...
                    {modules.map((module) => {
                        ...
                        return (
                            <Link
                                key={module.name}
                                href={module.href}
                                className={`group relative bg-[#0F0F0F] border border-[#222] hover:${module.borderColor} rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 flex flex-col justify-between overflow-hidden`}
                            >
                                ...
                                <div className="relative z-10">
                                    <div className={`w-14 h-14 rounded-xl ${module.bgColor} border border-white/5 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500`}>
                                        <Icon className={`w-7 h-7 ${module.textColor}`} />
                                    </div>
                                    <h4 className="text-2xl font-bold text-white mb-3 tracking-tight">
                                        {module.name}
                                    </h4>
                                    <p className="text-sm text-[#777] font-medium leading-relaxed mb-8">
                                        {module.description}
                                    </p>
                                </div>
                                
                                <div className="relative z-10 flex items-center justify-between border-t border-[#222] pt-6 mt-auto">
