        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 pt-4">
                ...
                <div className="lg:col-span-1 space-y-2">
                    <div className="bg-gray-50 dark:bg-[#0A0A0A] border border-gray-200 dark:border-[#222] rounded-2xl p-2 shadow-xl">
                        <button className="w-full flex items-center gap-3 px-4 py-3 bg-gray-100 dark:bg-[#1A1A1A] border border-[#B8860B]/20 rounded-xl text-left transition-all">
                ...
                <div className="lg:col-span-3">
                    <div className="bg-white dark:bg-[#0F0F0F] border border-gray-200 dark:border-[#222] rounded-2xl shadow-xl overflow-hidden relative">
                        ...
                        <div className="p-8 border-b border-gray-100 dark:border-[#222] bg-gray-50 dark:bg-[#141414]">
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white uppercase tracking-widest">Informações Pessoais</h3>
                            <p className="text-xs text-gray-400 dark:text-[#666] uppercase tracking-widest mt-1">Atualize sua foto e detalhes de contato do ERP.</p>
                        </div>

                        <div className="p-8 space-y-6">
                            <div className="flex items-center gap-6">
                                <div className="w-24 h-24 rounded-full bg-gray-100 dark:bg-gradient-to-br dark:from-[#1A1A1A] dark:to-[#0A0A0A] border-2 border-gray-300 dark:border-[#333] flex items-center justify-center shadow-lg">
                                    <User className="w-10 h-10 text-gray-400 dark:text-[#555]" />
                                </div>
                                <div>
                                    <button className="px-4 py-2 bg-gray-100 dark:bg-[#1A1A1A] border border-gray-300 dark:border-[#333] hover:border-[#B8860B]/50 text-gray-900 dark:text-white text-xs font-bold uppercase tracking-widest rounded-xl transition-all shadow-md">
                                        Alterar Avatar
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="p-6 border-t border-gray-200 dark:border-[#222] bg-gray-50 dark:bg-[#0A0A0A] flex justify-end">
