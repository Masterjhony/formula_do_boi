            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-8 pt-2 sm:pt-4">
                ...
                <div className="lg:col-span-1 space-y-2">
                    ...
                    <div className="lg:hidden flex gap-2 overflow-x-auto pb-2 -mx-1 px-1 scrollbar-thin">
                        <button className="shrink-0 flex items-center gap-2 px-3 py-2 bg-gray-100 dark:bg-[#1A1A1A] border border-[#B8860B]/30 rounded-xl">
                    ...
                    <div className="bg-white dark:bg-[#0F0F0F] border border-gray-200 dark:border-[#222] rounded-2xl shadow-xl overflow-hidden relative">
                        ...
                        <div className="p-4 sm:p-8 space-y-5 sm:space-y-6">
                            <div className="flex items-center gap-4 sm:gap-6">
                                ...
                                <div>
                                    <button className="px-3 sm:px-4 py-2 bg-gray-100 dark:bg-[#1A1A1A] border border-gray-300 dark:border-[#333] hover:border-[#B8860B]/50 text-gray-900 dark:text-white text-[10px] sm:text-xs font-bold uppercase tracking-widest rounded-xl transition-all shadow-md">
                                        Alterar Avatar
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="p-4 sm:p-6 border-t border-gray-200 dark:border-[#222] bg-gray-50 dark:bg-[#0A0A0A] flex justify-end">
                            <button className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-[#B8860B] to-[#9A7209] text-black font-bold text-xs uppercase tracking-widest rounded-xl shadow-lg shadow-[#B8860B]/20 hover:scale-105 transition-all opacity-50 cursor-not-allowed">
                                Salvar Alterações
                            </button>
                        </div>
                    </div>
