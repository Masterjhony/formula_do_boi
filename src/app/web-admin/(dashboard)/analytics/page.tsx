                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-200 dark:border-[#222222] shadow-xl overflow-hidden">
                                ...
                                <div className="p-6 space-y-3">
                                    {phEvents.length > 0 ? (
                                        phEvents.map((e, i) => (
                                            <div key={i} className="flex items-center justify-between text-sm border-b border-gray-100 dark:border-[#1A1A1A] pb-2 last:border-0">
                                        ...
                                        phPages.map((p, i) => {
                                            ...
                                            return (
                                                <div key={i} className="flex flex-col gap-1.5">
                                                    ...
                                                    <div className="w-full bg-gray-100 dark:bg-[#222222] rounded-full h-1.5">
...
function PHKpi({ label, value, icon, color, raw }: { label: string; value: number | string; icon: React.ReactNode; color: string; raw?: boolean }) {
    ...
    return (
        <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-200 dark:border-[#222222] p-4 shadow-lg">
...
function PHLink({ href, icon, title, subtitle }: { href: string; icon: React.ReactNode; title: string; subtitle: string }) {
    return (
        <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="block bg-white dark:bg-[#111111] rounded-2xl border border-gray-200 dark:border-[#222222] p-5 hover:border-fuchsia-500/40 hover:shadow-xl transition group"
        >
