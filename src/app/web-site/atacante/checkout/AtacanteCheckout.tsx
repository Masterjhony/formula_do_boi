...
/**
 * Checkout do Atacante da Matinha — espelho fiel do SertanejoCheckout.
 *
 * Tiers oficiais extraídos do PDF V3 "Atacante da Matinha · Lançamento
 * Touro Jovem Fórmula do Boi V3":
 *   1-100   doses → R$ 29,50 / dose  (Dose inicial)
 *   101-200 doses → R$ 27,50 / dose  (-7%)
 *   201-500 doses → R$ 25,50 / dose  (-14%) DESTAQUE
 *   501+    doses → R$ 23,50 / dose  (-20%)
 *
 * Reutiliza sertanejoLandingCss + checkoutExtraCss para paridade visual
 * total com o checkout do Sertanejo.
 */
...
const TIERS: Tier[] = [
    { range: "1 – 100 doses", rangeLabel: "1-100", price: "R$ 29", cents: ",50", sub: "/dose", note: "Dose inicial", suggestedDoses: 50 },
    { range: "101 – 200 doses", rangeLabel: "101-200", price: "R$ 27", cents: ",50", sub: "/dose", note: "−7% de desconto", suggestedDoses: 150 },
    { range: "201 – 500 doses", rangeLabel: "201-500", price: "R$ 25", cents: ",50", sub: "/dose", note: "−14% de desconto", badge: "Mais procurado", featured: true, accent: "gold", suggestedDoses: 300 },
    { range: "501+ doses", rangeLabel: "501+", price: "R$ 23", cents: ",50", sub: "/dose", note: "−20% de desconto", badge: "Atacado", accent: "green", suggestedDoses: 800 },
];
...
function getUtmParams() {
    ...
    return {
        ...
        utm_campaign: params.get("utm_campaign") || "atacante/checkout",
...
export default function AtacanteCheckout() {
    ...
    useEffect(() => {
        const id = "atacante-checkout-fonts";
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const data = {
            ...
            touro: "ATACANTE DA MATINHA (RDM B 3224 MAT.)",
            ...getUtmParams(),
        };
    ...
    // Estoque fictício no padrão Sertanejo. Pode virar dado real do Supabase.
    const reserved = 1800;
    const total = 5000;
        ...
        <div className="sertanejo-v2-wrap" style={{ minHeight: "100vh" }}>
            ...
            <div className="sert-dark-leather" style={{
                ...
                <span className="mono" style={{
                    ...
                    Aceleradora de Touros · Lançamento Nelore Visual 2026
                </span>
            </div>
            ...
            <nav className="sert-dark-leather" style={{
                ...
                <div className="ck-wrap" style={{
                    ...
                    <Link href="/atacante" style={{ display: "flex", alignItems: "center", gap: 12 }} aria-label="Fórmula do Boi — Voltar para Atacante">
                        <img src="/logo_complete.svg" alt="Fórmula do Boi" style={{ height: 30, width: "auto", display: "block" }} />
                    </Link>
                    <Link href="/atacante" className="mono nav-link-back" style={{
            ...
            <section className="ck-section sert-dark-leather">
                <div className="ck-wrap">
                    <TagPill>Aceleradora · Pré-reserva Atacante</TagPill>
                    ...
                    <p style={{
                        ...
                        Atacante da Matinha · RDM B 3224 MAT. · Nelore PO ·{" "}
                        MGTe 42,38 TOP 0,1% · ELITE em Peso, PE e AOL. Touro Jovem na Procriar SP —
                        pré-reserva aberta em condição promocional Fazenda Visual.
                    </p>
                    ...
                    <div style={{
                        ...
                        <span className="mono" style={{
                            ...
                            Procriar SP · 12 meses · Sêmen convencional e sexado
                        </span>
                    </div>
                </div>
            </section>
            ...
            <section className="ck-section sert-dark-leather" style={{ borderTop: "1px solid var(--st-rule-2)" }}>
                <div className="ck-wrap" style={{ textAlign: "center" }}>
                    <TagPill>Tabela promocional · Fazenda Visual</TagPill>

                    <h2 className="serif-tight" style={{
                        fontSize: "clamp(36px, 5.5vw, 72px)", color: "var(--st-bone)",
                        marginBottom: 14, fontWeight: 500,
                    }}>
                        Pacotes de <em style={{ color: "var(--st-gold-2)" }}>sêmen B3224.</em>
                    </h2>
                    <p style={{
                        fontSize: 16, color: "var(--st-txt)", maxWidth: 600,
                        margin: "0 auto 64px", fontWeight: 300, lineHeight: 1.6,
                    }}>
                        Condição válida para este lançamento. Quanto maior o volume, maior o desconto —
