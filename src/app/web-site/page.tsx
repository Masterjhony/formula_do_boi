...
import ParceirosOperacionais from "@/components/ParceirosOperacionais";
...
export default async function Home() {
    ...
    return (
        <main className="min-h-screen bg-ink">
            ...
            {/* 2 — Grupo Selo Ouro / VIP */}
            <WhatsappSection />

            {/* 3 — Sociedade com Bulinha */}
            <SociedadeBulinha />

            {/* 4 — Parceiros operacionais (Aceleradora + Central Bela Vista) */}
            <ParceirosOperacionais />

            {/* 5 — Sêmen Fórmula do Boi */}
