...
-- Período: 20/03/2026 a 20/04/2026
-- Saldo inicial do período: R$ 13.600,00
-- Saldo final: R$ 0,00
-- Total saídas: R$ 13.600,00 (21 lançamentos)
-- ============================================================
...
BEGIN
    ...
    IF v_account_id IS NULL THEN
        ...
        VALUES ('Banco Inter — CC 521573610', 'checking', 13600.00, 0.00)
    ...
    -- 2. Insere os lançamentos (ignora duplicatas exatas por data+descrição+valor)
    ...
    FROM (VALUES
        (1843.00, 'Pix enviado — Joao Eduardo Lucas Pereira',             '2026-03-20'::date),
        ( 200.00, 'Aplicação — CDB Crédito Banco Inter SA',               '2026-03-20'::date),
        ( 500.00, 'Aplicação — CDB Crédito Banco Inter SA',               '2026-03-20'::date),
        (1000.00, 'Pix enviado — Marcelo Carneiro Lucas Pereira',         '2026-03-23'::date),
        (  82.00, 'Pix enviado — Joao Eduardo Lucas Pereira',             '2026-03-25'::date),
        ( 151.81, 'Pix enviado — Joao Eduardo Lucas Pereira',             '2026-03-25'::date),
        ( 250.00, 'Pix enviado — Fabricio Moraes Lucas Pereira',          '2026-03-27'::date),
