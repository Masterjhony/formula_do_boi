-- FORCE FIX EMBRYOS & SEMEN
-- 1. First, delete the specific IDs to clear any old/conflicting data
DELETE FROM public.products WHERE id IN (1, 2, 3, 4, 5, 6, 102);

-- 2. Insert the correct data with OVERRIDING SYSTEM VALUE
